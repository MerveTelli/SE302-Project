...
-General information about lecture: name, code, semester.
-Operational information about lecture: theory, application/lab, local credits, ECTS. 
-Specification of lecture: prerequisites, course language, course type, course level, course coordinator, course lecturer(s).
